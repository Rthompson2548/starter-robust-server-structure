...
// res.locals: 
  // an object that contains response local variables 
  // scoped to the request, and therefore available only to the 
  // view(s) rendered during that request / response cycle (if any)
